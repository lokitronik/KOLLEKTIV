...
export const DisclaimerBanner: React.FC = () => {
  ...
  return (
    <div className="bg-slate-900/90 border-b border-slate-800/90 px-3 py-2 text-xs text-slate-300">
      <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-1.5 sm:gap-4">
        ...
        <div className="flex items-center gap-2 text-slate-300 text-center sm:text-left">
          ...
          <span className="leading-snug">
            <strong className="text-slate-100 font-semibold">Samhällsbaserad plattform:</strong>{' '}
            {t('disclaimer')}
          </span>
        </div>
        ...
        <div className="flex items-center gap-3 text-[11px] shrink-0">
          <span className={`inline-flex items-center gap-1.5 px-2.5 py-0.5 rounded-full font-bold tracking-wide ${
            isConnected
          ...
          <button
            ...
            className="text-slate-400 hover:text-slate-200 underline decoration-slate-600 underline-offset-2 transition-colors"
          >
            Regler & GDPR
          </button>
        </div>
